...
variable "enable_invoker_iam" {
  description = "Whether to enable Cloud Run invoker IAM. When true, invoker IAM will be enabled regardless of load balancer configuration."
  type        = bool
  default     = false
}
